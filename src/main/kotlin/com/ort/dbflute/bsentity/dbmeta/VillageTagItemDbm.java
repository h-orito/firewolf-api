...
public class VillageTagItemDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((VillageTagItem)et).getVillageTagItemCode(), (et, vl) -> ((VillageTagItem)et).setVillageTagItemCode((String)vl), "villageTagItemCode");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnVillageTagItemCode = cci("VILLAGE_TAG_ITEM_CODE", "VILLAGE_TAG_ITEM_CODE", null, null, String.class, "villageTagItemCode", null, true, false, true, "VARCHAR", 50, 0, null, null, false, null, null, null, "villageTagList", null, false);
