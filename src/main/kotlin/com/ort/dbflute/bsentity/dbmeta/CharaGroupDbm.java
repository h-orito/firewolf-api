...
public class CharaGroupDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((CharaGroup)et).getIsAvailableChangeName(), (et, vl) -> ((CharaGroup)et).setIsAvailableChangeName((Boolean)vl), "isAvailableChangeName");
    ...
    protected final ColumnInfo _columnIsAvailableChangeName = cci("IS_AVAILABLE_CHANGE_NAME", "IS_AVAILABLE_CHANGE_NAME", null, null, Boolean.class, "isAvailableChangeName", null, false, false, true, "BIT", null, null, null, null, false, null, null, null, null, null, false);
