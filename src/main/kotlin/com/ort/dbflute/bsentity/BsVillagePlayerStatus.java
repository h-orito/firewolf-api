...
public abstract class BsVillagePlayerStatus extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                              ======================
    /**
     * Set the value of villagePlayerStatusCode as 恋絆 (LOVE). <br>
     * 恋絆
     */
    public void setVillagePlayerStatusCode_恋絆() {
        setVillagePlayerStatusCodeAsVillagePlayerStatusType(CDef.VillagePlayerStatusType.恋絆);
    }
    ...
    //                                                        ============================
    /**
     * Is the value of villagePlayerStatusCode 恋絆? <br>
     * 恋絆
     * <p>It's treated as case insensitive and if the code value is null, it returns false.</p>
     * @return The determination, true or false.
     */
    public boolean isVillagePlayerStatusCode恋絆() {
