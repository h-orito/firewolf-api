...
public abstract class AbstractBsVillagePlayerStatusTypeCQ extends AbstractConditionQuery {
    ...
    /**
     * Equal(=). As 恋絆 (LOVE). And OnlyOnceRegistered. <br>
     * 恋絆
     */
    public void setVillagePlayerStatusTypeCode_Equal_恋絆() {
        setVillagePlayerStatusTypeCode_Equal_AsVillagePlayerStatusType(CDef.VillagePlayerStatusType.恋絆);
    }
    ...
    /**
     * NotEqual(&lt;&gt;). As 恋絆 (LOVE). And OnlyOnceRegistered. <br>
     * 恋絆
     */
    public void setVillagePlayerStatusTypeCode_NotEqual_恋絆() {
        setVillagePlayerStatusTypeCode_NotEqual_AsVillagePlayerStatusType(CDef.VillagePlayerStatusType.恋絆);
    }
