...
public abstract class AbstractBsPlayerCQ extends AbstractConditionQuery {
     ...
     * @param shouldCheckAccessInfo The value of shouldCheckAccessInfo as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setShouldCheckAccessInfo_Equal(Boolean shouldCheckAccessInfo) {
        regShouldCheckAccessInfo(CK_EQ, shouldCheckAccessInfo);
    }

    protected void regShouldCheckAccessInfo(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueShouldCheckAccessInfo(), "SHOULD_CHECK_ACCESS_INFO"); }
    protected abstract ConditionValue xgetCValueShouldCheckAccessInfo();
