...
public abstract class AbstractBsVillageSettingCQ extends AbstractConditionQuery {
    ...
    /**
     * Equal(=). As アクション可能か (is_available_action). And OnlyOnceRegistered. <br>
     * アクション可能か
     */
    public void setVillageSettingItemCode_Equal_アクション可能か() {
        setVillageSettingItemCode_Equal_AsVillageSettingItem(CDef.VillageSettingItem.アクション可能か);
    }
    ...
    /**
     * NotEqual(&lt;&gt;). As アクション可能か (is_available_action). And OnlyOnceRegistered. <br>
     * アクション可能か
     */
    public void setVillageSettingItemCode_NotEqual_アクション可能か() {
        setVillageSettingItemCode_NotEqual_AsVillageSettingItem(CDef.VillageSettingItem.アクション可能か);
    }
