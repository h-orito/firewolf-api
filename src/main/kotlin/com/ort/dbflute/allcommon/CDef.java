...
public interface CDef extends Classification {
    ...
    public enum Skill implements CDef {
        ...
        static {
            ...
            {
                Map<String, Object> subItemMap = new HashMap<String, Object>();
                subItemMap.put("shortName", "運");
                subItemMap.put("order", "14");
                subItemMap.put("campCode", "VILLAGER");
                subItemMap.put("description", "あなたは強運者です。特別な能力はありませんが、投票で最多票が複数いる場合、自分以外から処刑者が選ばれます。");
            ...
            {
                Map<String, Object> subItemMap = new HashMap<String, Object>();
                subItemMap.put("shortName", "風");
                subItemMap.put("order", "8");
                subItemMap.put("campCode", "VILLAGER");
                subItemMap.put("description", "あなたは風来狩人です。初日以外の毎晩、自分以外の一人を人狼の襲撃から守ることができます。ただし、護衛成功失敗にかかわらず、一度守った人は護衛することができません。");
         ...
         * @return The determination, true or false.
         */
        public boolean isViewableSympathizeSay() { return 共鳴者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 共鳴発言可能 <br>
         * The group elements:[共鳴者]
         * @return The determination, true or false.
         */
        public boolean isAvailableSympathizeSay() { return 共鳴者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 襲撃対象に選べない <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isDivineResultWolf() { return 人狼.equals(this) || 呪狼.equals(this) || 智狼.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 霊能結果が人狼になる <br>
         * The group elements:[人狼, 呪狼, 智狼, 大狼]
         ...
         * @return The determination, true or false.
         */
        public boolean isHasWiseDivineAbility() { return 賢者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 護衛能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasWandererGuardAbility() { return 風来狩人.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 霊能能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasGuruPsychicAbility() { return 導師.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 検死能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasAutopsyAbility() { return 検死官.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 襲撃役職占い能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasWiseWolfAbility() { return 智狼.equals(this); }
        /**
         * Is the classification in the group? <br>
         * パン焼き能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasBakeryAbility() { return パン屋.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 強運能力を持つ <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isHasLuckyAbility() { return 強運者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 勝敗判定時狼にカウントする <br>
         * The group elements:[人狼, 呪狼, 智狼, 大狼]
         ...
         * @return The determination, true or false.
         */
        public boolean isRecognizableEachSympathizer() { return 共鳴者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 人狼を認知できる <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isCounterDeadByDivine() { return 呪狼.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 死亡時道連れにする <br>
        ...
        public boolean inGroup(String groupName) {
            ...
            if ("viewableSympathizeSay".equalsIgnoreCase(groupName)) { return isViewableSympathizeSay(); }
            if ("availableSympathizeSay".equalsIgnoreCase(groupName)) { return isAvailableSympathizeSay(); }
            ...
            if ("hasWiseDivineAbility".equalsIgnoreCase(groupName)) { return isHasWiseDivineAbility(); }
            if ("hasGuardAbility".equalsIgnoreCase(groupName)) { return isHasGuardAbility(); }
            if ("hasWandererGuardAbility".equalsIgnoreCase(groupName)) { return isHasWandererGuardAbility(); }
            if ("hasPsychicAbility".equalsIgnoreCase(groupName)) { return isHasPsychicAbility(); }
            if ("hasGuruPsychicAbility".equalsIgnoreCase(groupName)) { return isHasGuruPsychicAbility(); }
            if ("hasAutopsyAbility".equalsIgnoreCase(groupName)) { return isHasAutopsyAbility(); }
            if ("hasWiseWolfAbility".equalsIgnoreCase(groupName)) { return isHasWiseWolfAbility(); }
            if ("hasBakeryAbility".equalsIgnoreCase(groupName)) { return isHasBakeryAbility(); }
            if ("hasLuckyAbility".equalsIgnoreCase(groupName)) { return isHasLuckyAbility(); }
            ...
            if ("recognizableEachSympathizer".equalsIgnoreCase(groupName)) { return isRecognizableEachSympathizer(); }
            ...
            if ("counterDeadByDivine".equalsIgnoreCase(groupName)) { return isCounterDeadByDivine(); }
        ...
        public static List<Skill> listByGroup(String groupName) {
            ...
            if ("hasWandererGuardAbility".equalsIgnoreCase(groupName)) { return listOfHasWandererGuardAbility(); }
            ...
            if ("hasLuckyAbility".equalsIgnoreCase(groupName)) { return listOfHasLuckyAbility(); }
        ...
        public static List<Skill> listOfViewableSympathizeSay() {
            return new ArrayList<>(Arrays.asList(共鳴者));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 共鳴発言可能 <br>
        ...
        public static List<Skill> listOfHasWiseDivineAbility() {
            return new ArrayList<>(Arrays.asList(賢者));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 護衛能力を持つ <br>
         ...
         * @return The snapshot list of classification elements in the group. (NotNull)
         */
        public static List<Skill> listOfHasWandererGuardAbility() {
            return new ArrayList<>(Arrays.asList(風来狩人));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 霊能能力を持つ <br>
        ...
        public static List<Skill> listOfHasGuruPsychicAbility() {
            return new ArrayList<>(Arrays.asList(導師));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 検死能力を持つ <br>
        ...
        public static List<Skill> listOfHasAutopsyAbility() {
            return new ArrayList<>(Arrays.asList(検死官));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 襲撃役職占い能力を持つ <br>
        ...
        public static List<Skill> listOfHasWiseWolfAbility() {
            return new ArrayList<>(Arrays.asList(智狼));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * パン焼き能力を持つ <br>
        ...
        public static List<Skill> listOfHasBakeryAbility() {
            return new ArrayList<>(Arrays.asList(パン屋));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 強運能力を持つ <br>
         ...
         * @return The snapshot list of classification elements in the group. (NotNull)
         */
        public static List<Skill> listOfHasLuckyAbility() {
            return new ArrayList<>(Arrays.asList(強運者));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 勝敗判定時狼にカウントする <br>
        ...
        public static List<Skill> listOfCounterDeadByDivine() {
            return new ArrayList<>(Arrays.asList(呪狼));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 死亡時道連れにする <br>
    ...
    public enum MessageType implements CDef {
        ...
        /** 恋人メッセージ */
        恋人メッセージ("PRIVATE_LOVERS", "恋人メッセージ"),
        /** 共有相互確認メッセージ */
        ...
        /** 共鳴相互確認メッセージ */
        共鳴相互確認メッセージ("PRIVATE_SYMPATHIZER", "共鳴相互確認メッセージ"),
        /** 非公開システムメッセージ */
    ...
    public enum VillageSettingItem implements CDef {
        ...
        /** プロローグダミー発言 */
        プロローグダミー発言("day0_dummy_message", "プロローグダミー発言"),
        /** 1日目ダミー発言 */
        N1日目ダミー発言("day1_dummy_message", "1日目ダミー発言"),
        /** ダミーキャラID */
        ダミーキャラid("dummy_chara_id", "ダミーキャラID"),
        /** ダミーキャラ名 */
        ダミーキャラ名("dummy_chara_name", "ダミーキャラ名"),
        /** ダミーキャラ略称 */
        ダミーキャラ略称("dummy_chara_short_name", "ダミーキャラ略称"),
        /** 自動生成村か */
        自動生成村か("is_auto_generated", "自動生成村か"),
        /** アクション可能か */
        アクション可能か("is_available_action", "アクション可能か"),
        /** コミット可能か */
        コミット可能か("is_available_commit", "コミット可能か"),
        /** 役欠けありか */
        役欠けありか("is_available_dummy_skill", "役欠けありか"),
        /** 連続護衛可能か */
        連続護衛可能か("is_available_guard_same_target", "連続護衛可能か"),
        /** 秘話可能か */
        秘話可能か("is_available_secret_say", "秘話可能か"),
        /** 役職希望可能か */
