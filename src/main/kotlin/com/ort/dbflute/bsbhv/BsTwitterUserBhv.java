 ...
 */
public abstract class BsTwitterUserBhv extends AbstractBehaviorWritable<TwitterUser, TwitterUserCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public TwitterUserDbm asDBMeta() { return TwitterUserDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public TwitterUserCB newConditionBean() { return new TwitterUserCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of TwitterUser. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<TwitterUserCB> cbLambda) {
     ...
     */
    public OptionalEntity<TwitterUser> selectEntity(CBCall<TwitterUserCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<TwitterUser> facadeSelectEntity(TwitterUserCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends TwitterUser> OptionalEntity<ENTITY> doSelectOptionalEntity(TwitterUserCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * TwitterUser <span style="color: #553000">twitterUser</span> = <span style="color: #0000C0">twitterUserBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public TwitterUser selectEntityWithDeletedCheck(CBCall<TwitterUserCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<TwitterUser> selectByPK(Integer playerId) {
        return facadeSelectByPK(playerId);
    }

    protected OptionalEntity<TwitterUser> facadeSelectByPK(Integer playerId) {
        return doSelectOptionalByPK(playerId, typeOfSelectedEntity());
    }

    protected <ENTITY extends TwitterUser> ENTITY doSelectByPK(Integer playerId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(playerId), tp);
    }

    protected <ENTITY extends TwitterUser> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer playerId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(playerId, tp), playerId);
    }

    protected TwitterUserCB xprepareCBAsPK(Integer playerId) {
     ...
     * <pre>
     * ListResultBean&lt;TwitterUser&gt; <span style="color: #553000">twitterUserList</span> = <span style="color: #0000C0">twitterUserBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (TwitterUser <span style="color: #553000">twitterUser</span> : <span style="color: #553000">twitterUserList</span>) {
     *     ... = <span style="color: #553000">twitterUser</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of TwitterUser. (NotNull)
     ...
     */
    public ListResultBean<TwitterUser> selectList(CBCall<TwitterUserCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;TwitterUser&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">twitterUserBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (TwitterUser twitterUser : <span style="color: #553000">page</span>) {
     *     ... = twitterUser.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of TwitterUser. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<TwitterUser> selectPage(CBCall<TwitterUserCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of TwitterUser. (NotNull)
     * @param entityLambda The handler of entity row of TwitterUser. (NotNull)
     */
    public void selectCursor(CBCall<TwitterUserCB> cbLambda, EntityRowHandler<TwitterUser> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<TwitterUserCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<TwitterUser> twitterUserList, ReferrerLoaderHandler<LoaderOfTwitterUser> loaderLambda) {
        xassLRArg(twitterUserList, loaderLambda);
        loaderLambda.handle(new LoaderOfTwitterUser().ready(twitterUserList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(TwitterUser twitterUser, ReferrerLoaderHandler<LoaderOfTwitterUser> loaderLambda) {
        xassLRArg(twitterUser, loaderLambda);
        loaderLambda.handle(new LoaderOfTwitterUser().ready(xnewLRAryLs(twitterUser), _behaviorSelector));
    }
     ...
     */
    public List<Player> pulloutPlayer(List<TwitterUser> twitterUserList)
    { return helpPulloutInternally(twitterUserList, "player"); }
     ...
     */
    public List<Integer> extractPlayerIdList(List<TwitterUser> twitterUserList)
    { return helpExtractListInternally(twitterUserList, "playerId"); }
     ...
     * <pre>
     * TwitterUser twitterUser = <span style="color: #70226C">new</span> TwitterUser();
     ...
     */
    public void insert(TwitterUser twitterUser) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(TwitterUser twitterUser) {
     ...
     */
    public int[] batchInsert(List<TwitterUser> twitterUserList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<TwitterUser> twitterUserList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<TwitterUser> twitterUserList) {
     ...
     * <pre>
     * <span style="color: #0000C0">twitterUserBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;TwitterUser, TwitterUserCB&gt;() {
     *     public ConditionBean setup(TwitterUser entity, TwitterUserCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<TwitterUser, TwitterUserCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(TwitterUser twitterUser, CBCall<TwitterUserCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<TwitterUserCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(TwitterUser twitterUser, WritableOptionCall<TwitterUserCB, InsertOption<TwitterUserCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(TwitterUser twitterUser, WritableOptionCall<TwitterUserCB, UpdateOption<TwitterUserCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(TwitterUser twitterUser, WritableOptionCall<TwitterUserCB, InsertOption<TwitterUserCB>> insertOpLambda, WritableOptionCall<TwitterUserCB, UpdateOption<TwitterUserCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(TwitterUser twitterUser, WritableOptionCall<TwitterUserCB, DeleteOption<TwitterUserCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<TwitterUser> twitterUserList, WritableOptionCall<TwitterUserCB, InsertOption<TwitterUserCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<TwitterUser> twitterUserList, WritableOptionCall<TwitterUserCB, UpdateOption<TwitterUserCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<TwitterUser> twitterUserList, WritableOptionCall<TwitterUserCB, DeleteOption<TwitterUserCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<TwitterUser, TwitterUserCB> manyArgLambda, WritableOptionCall<TwitterUserCB, InsertOption<TwitterUserCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(TwitterUser twitterUser, CBCall<TwitterUserCB> cbLambda, WritableOptionCall<TwitterUserCB, UpdateOption<TwitterUserCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<TwitterUserCB> cbLambda, WritableOptionCall<TwitterUserCB, DeleteOption<TwitterUserCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<TwitterUserBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends TwitterUser> typeOfSelectedEntity() { return TwitterUser.class; }
    protected Class<TwitterUser> typeOfHandlingEntity() { return TwitterUser.class; }
    protected Class<TwitterUserCB> typeOfHandlingConditionBean() { return TwitterUserCB.class; }
