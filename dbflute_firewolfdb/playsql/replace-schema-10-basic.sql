...
(
    MESSAGE_SENDTO_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'メッセージ送信先ID',
    VILLAGE_ID        INT UNSIGNED NOT NULL COMMENT '村ID',
    MESSAGE_NUMBER    INT UNSIGNED NOT NULL COMMENT 'メッセージ番号',
    MESSAGE_TYPE_CODE VARCHAR(20)  NOT NULL COMMENT 'メッセージ種別コード',
    VILLAGE_PLAYER_ID INT UNSIGNED NOT NULL COMMENT '村参加者ID',
    REGISTER_DATETIME DATETIME     NOT NULL COMMENT '登録日時',
    REGISTER_TRACE    VARCHAR(255) NOT NULL COMMENT '登録トレース',
    UPDATE_DATETIME   DATETIME     NOT NULL COMMENT '更新日時',
    UPDATE_TRACE      VARCHAR(255) NOT NULL COMMENT '更新トレース',
    PRIMARY KEY (MESSAGE_SENDTO_ID)
) COMMENT = 'メッセージ送信先';
...
ALTER TABLE MESSAGE_SENDTO
    ADD CONSTRAINT FK_MESSAGE_SENDTO_MESSAGE FOREIGN KEY (VILLAGE_ID, MESSAGE_NUMBER, MESSAGE_TYPE_CODE)
        REFERENCES MESSAGE (VILLAGE_ID, MESSAGE_NUMBER, MESSAGE_TYPE_CODE)
        ON UPDATE RESTRICT
        ON DELETE RESTRICT
;
